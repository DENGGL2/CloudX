...
internal class RemoteConnectorClient(
    ...
    private suspend inline fun <reified T> executeJson(
        ...
        val response = executeRaw(method, path, headers, body, mediaType)
    ...
    private suspend fun executeRaw(
        ...
        webRtcTransport?.let { return it.request(method, path, requestHeaders, body) }
...
private fun Throwable.toPairingMessage(): String = when (this) {
    is RemoteConnectorException -> message ?: "电脑端连接失败"
